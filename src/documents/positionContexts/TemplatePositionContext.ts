...
export class TemplatePositionContext extends PositionContext {
    ...
    public getSnippetInsertionContext(options: { triggerCharacter?: string; allowInsideJsonString?: boolean }): SnippetInsertionContext {
        const insertionContext = super.getSnippetInsertionContext(options);
